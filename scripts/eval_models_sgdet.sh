...
if [ $1 == "0" ]; then
    ...
    python models/eval_rels.py -m sgdet -model linknet -b 6 -clip 5 -p 100 -hidden_dim 256 -pooling_dim 4096 \
        -lr 1e-3 -ngpu 1 -test -ckpt checkpoints/linknet-sgdet/vgrel-15.tar -nepoch 50 -use_bias -cache linknet_sgdet
fi
