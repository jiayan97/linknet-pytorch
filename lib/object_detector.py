"""
Adapted from https://github.com/rowanz/neural-motifs/blob/master/lib/object_detector.py

Add gce_obj_dists and gce_obj_labels to Result
"""
...
class Result(object):
    ...
    def __init__(self, od_obj_dists=None, rm_obj_dists=None, gce_obj_dists=None, gce_obj_labels=None,
